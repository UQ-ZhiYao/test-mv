...
function stmtForInvestorFy(investorId,fyId){if(!investorId||!fyId)return null;return(STATEMENTS||[]).filter(function(s){return s.type==="Dividend"&&s.investor_id===investorId&&s.fy_id===fyId})[0]||null}
