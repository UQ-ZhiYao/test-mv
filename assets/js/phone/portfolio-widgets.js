...
var ZY_STMT_ORIG_VIEWPORT=null;
function zySetStatementZoomable(on){var vp=document.querySelector('meta[name="viewport"]');if(!vp)return;var content;if(on){if(ZY_STMT_ORIG_VIEWPORT===null)ZY_STMT_ORIG_VIEWPORT=vp.getAttribute("content");content="width=device-width, initial-scale=1.0, viewport-fit=cover"}else if(ZY_STMT_ORIG_VIEWPORT!==null){content=ZY_STMT_ORIG_VIEWPORT;ZY_STMT_ORIG_VIEWPORT=null}else{return}var parent=vp.parentNode,next=vp.nextSibling;parent.removeChild(vp);vp.setAttribute("content",content);if(next)parent.insertBefore(vp,next);else parent.appendChild(vp)}
