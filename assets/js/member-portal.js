  ...
  if(activeFRTab==='income'){
    ...
    if(CASH_FLOW_ERROR){
      ...
      table='<table style="width:100%;border-collapse:collapse">'+fsThead(CASH_FLOW,'RM')+'<tbody>'
        ...
        +fsRow(CASH_FLOW,'Net Proceeds from (Investment) / Disposal — Securities','proceedsSecurities',false,null,false,true)
        +fsRow(CASH_FLOW,'Net Proceeds from (Investment) / Disposal — Other Assets','proceedsOtherAssets',false,null,false,true)
