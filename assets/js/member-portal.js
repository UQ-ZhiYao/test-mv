...
function chartHTML(period) {
  ...
  return '<div style="position:relative">'
    ...
    +'<path d="'+r.d+'" fill="none" stroke="#1565C0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
...
function initChart(period) {
  ...
  ov.addEventListener('mousemove',function(e){
    ...
    tip.innerHTML='<div style="font-size:.72rem;font-weight:600;color:#1565C0;margin-bottom:3px">'+lbl+'</div><div style="font-size:1.05rem;font-weight:700;color:#0F172A;letter-spacing:-.01em">RM '+v.toFixed(4)+'</div>';
